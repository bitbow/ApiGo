...
begin
  ...
  if ActionName = 'GetTable' then
    IsAuthorized := True;
  if ActionName = 'GetTableItem' then
    IsAuthorized := True;
  if ActionName = 'CreateTableItem' then
    IsAuthorized := True;
  if ActionName = 'UpdateTableItem' then
    IsAuthorized := True;
  if ActionName = 'DeleteTableItem' then
    IsAuthorized := True;
...
begin
  AuthenticationRequired := ControllerQualifiedClassName =
    'UMVCcontroller.TApiGoController';
